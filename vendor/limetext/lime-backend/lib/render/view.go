...
import (
	"github.com/gbbr/textmate/vendor/limetext/lime-backend/lib/util"
...
type (
	...
	// and can be set both by a https://godoc.org/github.com/gbbr/textmate/vendor/limetext/lime-backend/lib/parser#SyntaxHighlighter
	// and from plugins via https://godoc.org/github.com/gbbr/textmate/vendor/limetext/lime-backend/lib#View.AddRegions.
	//
	// Turning this information into a concrete https://godoc.org/github.com/gbbr/textmate/vendor/limetext/lime-backend/lib/render#Flavour
	// is the job of the https://godoc.org/github.com/gbbr/textmate/vendor/limetext/lime-backend/lib/render#ColourScheme interface.
	ViewRegions struct {
